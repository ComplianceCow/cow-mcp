...
async def get_graph_schema_relationship() -> dict | str:
    ...
    try:
        ...
        enhanced_guidance = {
            ...
            "Risks": "RiskItem nodes are attached to control-config via HAS_RISK & HAS_MAPPED_CONTROL edges and RiskItemAttribute nodes are attached to RiskItem via HAS_ATTRIBUTE edges "
        }
